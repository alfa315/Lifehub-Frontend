...
const EditTodoModal = (props) => {
  return(
    <Modal trigger={<div className='modal-button'><Popup name={props.item.id} trigger={<Button onClick={props.handleClick} name={props.item.id} color='yellow' icon='edit'/>} content='Edit To-Do'/></div>}>
